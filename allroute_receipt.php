...
if ($token) {
    $stmt = $conn->prepare("SELECT * FROM all_route_pass WHERE application_token = ?");
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .receipt-card { max-width:550px; margin:0 auto; background:#fff; border:2px dashed #d9534f; border-radius:8px; padding:25px; margin-top: 35px; }
